...
//			}
	...
	public boolean whitepawnplay(int x, int y)
	{
		...
		if(moved == false && model.getBoardContents(x, y-2) == 0 && model.getBoardContents(x, y-1) == 0)
		{
	...
	public void blackrookplay(int x, int y)
	{
		...
		{
			i++;
			if(model.getBoardContents(i, y) > 0 && model.getBoardContents(i, y) < 90)
			{
				model.setBoardContents(i, y, (model.getBoardContents(i, y)+100));
			}
			if(model.getBoardContents(i, y) != 0)
		...
		{
			i2--;
			if(model.getBoardContents(i2, y) > 0 && model.getBoardContents(i2, y) < 90)
			{
				model.setBoardContents(i2, y, (model.getBoardContents(i2, y)+100));
			}
			if(model.getBoardContents(i2, y) != 0)
		...
		{
			j++;
			if(model.getBoardContents(x, j) > 0 && model.getBoardContents(x, j) < 90)
			{
				model.setBoardContents(x, j, (model.getBoardContents(x, j)+100));
			}
			if(model.getBoardContents(x, j) != 0)
		...
		while(j2!=0)
		{
			...
			if(model.getBoardContents(x, j2) > 0 && model.getBoardContents(x, j2) < 90)
			{
				model.setBoardContents(x, j2, (model.getBoardContents(x,j2)+100));
			}
			if(model.getBoardContents(x, j2) != 0)
	...
	public void blackknightplay(int x, int y)
	{
		// 8 possible moves 
		// need to find boundary
		System.out.println(x);
		if(x <= 5)
		{
			if(y>0)
			{
				if(model.getBoardContents(x+2, y-1) >= 0 && model.getBoardContents(x+2, y-1) < 90)
				{
					model.setBoardContents(x+2, y-1, (model.getBoardContents(x+2, y-1)+100));
				}
			}
		...
		if(y <= 5)
		{
			if(x>0)
			{
				if(model.getBoardContents(x-1, y+2) >= 0 && model.getBoardContents(x-1, y+2) < 90)
				{
					model.setBoardContents(x-1, y+2, (model.getBoardContents(x-1, y+2)+100));
				}
			}
	...
	public void blackbishopplay(int x, int y)
	{
		//4 directions diagonally
		int i = x;
		int j = y;
		while(i!=7 && j!=7)
		{
			i++;
			j++;
			if(model.getBoardContents(i, j) > 0 && model.getBoardContents(i, j) < 90)
			{
				model.setBoardContents(i, j, (model.getBoardContents(i, j)+100));
			}
			if(model.getBoardContents(i, j) != 0)
		...
		while(i2!=0 && j2!=0)
		{
			i2--;
			j2--;
			if(model.getBoardContents(i2, j2) > 0 && model.getBoardContents(i2, j2) < 90)
			{
				model.setBoardContents(i2, j2, (model.getBoardContents(i2, j2)+100));
			}
			if(model.getBoardContents(i2, j2) != 0)
		...
		while(i3!=7 && j3!=0)
		{
			i3++;
			j3--;
			if(model.getBoardContents(i3, j3) > 0 && model.getBoardContents(i3, j3) < 90)
			{
				model.setBoardContents(i3, j3, (model.getBoardContents(i3, j3)+100));
			}
			if(model.getBoardContents(i3, j3) != 0)
		...
		while(i4!=0 && j4!=7)
		{
			i4--;
			j4++;
			if(model.getBoardContents(i4, j4) > 0 && model.getBoardContents(i4, j4) < 90)
			{
				model.setBoardContents(i4, j4, (model.getBoardContents(i4, j4)+100));
			}
			if(model.getBoardContents(i4, j4) != 0)
	...
	public void blackqueenplay(int x, int y)
	{
		//bishop 
		//4 directions diagonally
				int i = x;
				...
				{
					q++;
					if(model.getBoardContents(q, y) > 0 && model.getBoardContents(q, y) < 90)
					{
				...
				{
					q2--;
					if(model.getBoardContents(q2, y) > 0 && model.getBoardContents(q2, y) < 90)
					{
				...
				{
					w++;
					if(model.getBoardContents(x, w) > 0 && model.getBoardContents(x, w) < 90)
					{
				...
				while(w2!=0)
				{
					...
					if(model.getBoardContents(x, w2) > 0 && model.getBoardContents(x, w2) < 90)
					{
	...
	public void blackkingplay(int x, int y)
	{
		//any direction 1 place
		if(x!=7)
		{
			if(model.getBoardContents(x+1, y) >= 0 && model.getBoardContents(x+1, y) < 90)
			{
				model.setBoardContents(x+1, y, (model.getBoardContents(x+1,y)+100));
			}
		}
		...
		if(y!=7)
		{
			if(model.getBoardContents(x, y+1) >= 0 && model.getBoardContents(x, y+1) < 90)
			{
				model.setBoardContents(x, y+1, (model.getBoardContents(x,y+1)+100));
			}
		}
	...
	public boolean checkmate() {
		for(int i=0;i<8;i++) 
		{
			for(int j=0;j<8;j++)
			{
				if(model.getBoardContents(i, j) == 6 || model.getBoardContents(i, j) == -6)
				{
					return false;
				}
			}
